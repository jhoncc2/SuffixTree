...
//			}
		...
		cout << "bifucating " << localString << str  << " " << diffIndex << " " << localString[diffIndex] << str[diffIndex] << endl;
		// bifurcate
	...
	void printSubstring() {
		cout << std::string(charIndex, '.') << '<' << charIndex << ',' << intervalIndex <<'>'
						<< nodeSubstring() << endl;
	}
